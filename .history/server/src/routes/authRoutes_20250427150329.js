...
authRoute.post('/signup', async (req, res) => {
    ...
    if (!username || !password || !email|| !confirmPassword || !firstName || !lastName || !buildingNum || !street || !aptName || !city || !state || !zip || !passportNum || !passportExpiration || !passportCountry || !dateOfBirth || !phoneNumber) {
