...
// I'll make some changes to the actual input values based on schema
...
const CustomerLogin = () => {
  ...
  const renderNameFields = () => (
    <>
      ...
      <input type="text" name="firstName" value={formData.name} onChange={handleChange} placeholder="Full Name" required />
    </>
  );
  ...
  const renderAddressFields = () => (
    <>
      ...
      <input type="text" name="aptName" value={formData.aptName} onChange={handleChange} placeholder="Apartment (optional)" />
